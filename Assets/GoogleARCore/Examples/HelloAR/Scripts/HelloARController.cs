...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    {
        // float for double tap used for jump

        float touchDuration;

        // Instead of spawning of dragons everytime the user touches the screen. I am going to try for only one dragon to spawn and control that one.
